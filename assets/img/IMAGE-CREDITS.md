...
All images listed here are sourced from [Unsplash](https://unsplash.com) under the [Unsplash License](https://unsplash.com/license) — free for commercial and non-commercial use, no attribution required.

Replace with Atlas project photography when available.

---

## Guide images — sourced August 2026

| File | Unsplash photo ID | Photographer | Guide |
|---|---|---|---|
| `guide-kitchen-design.jpg` | `KuLVrz8KWs0` | Lisa Anna ([@lisaanna195](https://unsplash.com/@lisaanna195)) | /guides/kitchen-design-ideas/ |
| `guide-bathroom-remodel-ideas.jpg` | `3M74VAZi-rE` | Franco Debartolo ([@francotheshooter](https://unsplash.com/@francotheshooter)) | /guides/bathroom-remodel-ideas/ |
| `guide-bathroom-tile.jpg` | `Ies-rhvusTs` | Smart Renovations | /guides/bathroom-tile-ideas/ |
| `guide-custom-builtins.jpg` | `drvV17ILSjs` | Pickawood ([@pickawood](https://unsplash.com/@pickawood)) | /guides/custom-built-ins-cost-bucks-county/ |
...
## Existing site images (pre-August 2026)

Sources for the original guide images are not documented — confirm licensing with Rachel/John if reuse is needed beyond the current site.
